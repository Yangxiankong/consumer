...
func main() {
	...
	snatchPartionList, err := consumer.Partitions("snatch")
	openPartionList, err := consumer.Partitions("open")
	cachePartionList, err := consumer.Partitions("cache")
	if err != nil {
	...
	for snatchPartion := range snatchPartionList {
	...
	for openPartion := range openPartionList {
	...
	for cachePartion := range cachePartionList {
